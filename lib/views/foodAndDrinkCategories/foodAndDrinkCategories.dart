...
import '../categoriesExpand/categoriesExpand.dart';

class FoodAndDrinkCategories extends StatefulWidget {
  const FoodAndDrinkCategories({Key? key}) : super(key: key);

  @override
  State<FoodAndDrinkCategories> createState() => _FoodAndDrinkCategoriesState();
}

class _FoodAndDrinkCategoriesState extends State<FoodAndDrinkCategories> {
  ...
  void _selectItem(int index) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CategoriesExpand()),
    );
  }
